...
export const en = {
  ...
  applications: {
    ...
    closePostingForm: "Close form",
    postingsHelp: "Continue from an existing posting or add a new one.",
    compareTitle: "Compare job postings",
    compareHelp: "Compare conditions and detected technology stacks for up to 3 postings.",
    addCompare: "Add to comparison",
    removeCompare: "Remove from comparison",
    detectedStack: "Detected stack",
    compareFailed: "Comparison material could not be loaded.",
